const CHATS_FAKE_DATA = [
  {
    chat_name: "Conversation 1",
    chat_id: 1,
  },
  {
    chat_name: "Conversation 2",
    chat_id: 2,
  },
  {
    chat_name: "Conversation 3",
    chat_id: 3,
  },
];
...
const MESSAGES = [
  {
    ...
    messages: [
      ...
      {
        message: "Please do reply me",
        type: "incoming",
      },
      {
        message: "Busy! Will reply later!",
        type: "outgoing",
      },
    ],
  },
  ...
  },
  {
    ...
    messages: [
      ...
      {
        message: "How are you celebrating?",
        type: "incoming",
      },
      {
